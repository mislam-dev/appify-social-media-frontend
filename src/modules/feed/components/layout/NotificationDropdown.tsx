...
import { NOTIFICATIONS } from "@/modules/feed/data/mock";

export function NotificationDropdown() {
  const open = useFeedUiStore((s) => s.openDropdown === "notifications");
  ...
  return (
    <li className="nav-item _header_nav_item">
      ...
      >
        ...
        <div
          id="_notify_drop"
          className={cn("_notification_dropdown", open && "show")}
        >
                ...
                <div className="_notification_box" key={n.id}>
                  ...
                  <div className="_notification_txt">
                    <p className="_notification_para">
                      <span className="_notify_txt_link">{n.highlight} </span>
                      {n.text}
                    </p>
