...
const MEDIA_BUTTONS = [
  { key: "photo", label: "Photo", icon: PhotoIcon, cls: "_feed_inner_text_area_bottom_photo" },
  { key: "video", label: "Video", icon: VideoIcon, cls: "_feed_inner_text_area_bottom_video" },
  { key: "event", label: "Event", icon: EventIcon, cls: "_feed_inner_text_area_bottom_event" },
  { key: "article", label: "Article", icon: ArticleIcon, cls: "_feed_inner_text_area_bottom_article" },
];
